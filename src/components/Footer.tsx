...
const socialLinks = [
  {
    name: "Facebook",
    url: "https://www.facebook.com/rudrakshservices",
    icon: (
  ...
  {
    name: "Instagram",
    url: "https://www.instagram.com/rudrakshaservices",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Pinterest",
    url: "https://pinterest.com/rudrakshaservices/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/company/rudrakshservices",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "YouTube",
    url: "https://www.youtube.com/@rudrakshservices",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
